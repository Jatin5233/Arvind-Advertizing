...
const SERVICES = [
  ...
  "/sign-board/backlit-sign-board-retail-store-branding-delhi.webp",
  "/sign-board/acp-sign-board-shop-front-interior-branding.webp",
  "/sign-board/indoor-sign-board-corporate-office-wayfinding.webp",
],
  },
  {
    icon: Printer,
  ...
  "/flex-printing/flex-standee-anmol-brand-promotional-printing.webp",
  ...
  "/event-branding/exhibition-stall-branding-green-display-india.webp",
