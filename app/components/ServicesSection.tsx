...
const SERVICES = [
  ...
  },
  {
    ...
    accent:"from-orange-500/30 to-orange-800/10",
    tag:   "",
  },
  {
    icon:  Square,
  ...
  },
  {
    ...
    img:   "https://images.unsplash.com/photo-1497215728101-856f4ea42174?w=600&h=400&fit=crop",
    accent:"from-teal-600/30 to-teal-900/10",
    tag:   "",
  },
] as const;
